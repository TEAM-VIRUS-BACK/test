...
████████████████████████████████████████████████████████████████
                         DDos ARMY
    ┌─────────────────────────────────────────────────────┐
    │ version 1.2.8     (-_-)  CODE BY :: Team Virus  │
    │                                                     │
    │             [!!!Prevent Illegal CC-Attack!!!]       │
    │ Developer : H 4 C K E R                          │
    │ Gmail     : teamvirus.bd@gmail.com                 │
    │ YouTube   : https://t.me/team_virus_back                     │
    │ Facebook  : Mohammad Fahim                    │                      
    │ Instagram : Mohammad Fahim                │
    │             [!!!Any Bug please report me!!!]        │
    ├─────────────────────────────────────────────────────┤
    │       Github: https://github.com/TEAM-VIRUS-BACK      │
    │           [!]DO NOT ATTACK BD GOV WEBSITE[!]           │
    └─────────────────────────────────────────────────────┘\r\n''')
